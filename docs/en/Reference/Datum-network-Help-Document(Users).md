...
After setting the relevant information, click on [Creat Credential], complete signification confirmation for the transaction via Metamask to accomplish the credential.<img src="/network-user-img/Metamask签名确认-4.png" alt="Metamask签名确认-4" style="zoom:50%;" />
