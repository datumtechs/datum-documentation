<template><div><h1 id="数据资产发行" tabindex="-1"><a class="header-anchor" href="#数据资产发行" aria-hidden="true">#</a> 数据资产发行</h1>
<p>数据资产发行是以NFT的形式，将原始数据打包固定成一类特殊的资产，通过NFT的形式实现对资产的权利确认、交易使用、收益获得。</p>
<p><strong>支持的数据资产发行类型</strong></p>
<ul>
<li>发行NFT-721数据资产</li>
<li>设置NFT属性和使用权限</li>
</ul>
<h3 id="获取nft合约模板" tabindex="-1"><a class="header-anchor" href="#获取nft合约模板" aria-hidden="true">#</a> 获取NFT合约模板</h3>
<p>为了方便用户一键发布数据资产，Datum提供一系列NFT合约模板，例如：NFT721合约模板。用户也可在NFT合约模板的基础，通过合约属性的设置，发行自定义数据资产。</p>
...
<p>用户在获取NFT合约模板后，可选择关联已传输的原始数据，或者发布的元数据，完成NFT合约部署。不同的原始数据由不同的NFT合约进行管理。</p>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="铸造data-token" tabindex="-1"><a class="header-anchor" href="#铸造data-token" aria-hidden="true">#</a> 铸造Data Token</h3>
<p>用户能够基于已发布的NFT合约，铸造不同属性的Data token并设置数量，来完成对不同原始数据的资产化操作。数据资产的分享、交易、使用都将以Data Token作为凭证实现操作。</p>
<p><strong>如何使用</strong></p>
<ul>
<li>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="销毁data-token" tabindex="-1"><a class="header-anchor" href="#销毁data-token" aria-hidden="true">#</a> 销毁Data Token</h3>
<p>用户可以自行销毁已经铸造的且未被交易使用的Data Token。</p>
<p><strong>如何使用</strong></p>
<ul>
<li>
...
<span class="line"><span style="color: #F8F8F2">     --header </span><span style="color: #E6DB74">&#39;Content-Type: application/json&#39;</span><span style="color: #F8F8F2"> \</span></span>
<span class="line"><span style="color: #F8F8F2">     --header </span><span style="color: #E6DB74">&#39;X-API-Key: test&#39;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="data-token属性设置" tabindex="-1"><a class="header-anchor" href="#data-token属性设置" aria-hidden="true">#</a> Data Token属性设置</h3>
<p>Data Token支持添加、修改、管理各类属性，属性可用户定义该Token的使用权限及使用方式。</p>
<ul>
<li>具体分为：</li>
</ul>
<p>a、所有权属性设置。管理Data Token交易买卖后的持有对象，所有权属性的变更意味着持有人的变更。</p>
<p>b、使用方式属性设置。管理Data Token交易后能够按次数、按期限访问该Token对应的原始数据。</p>
<p>c、使用权限属性设置。管理Data Token交易后能够查看、下载该Token对应的原始数据或元数据权限。</p>
<p>d、其他属性设置。管理Data Token对应的原始数据存储路径、或其他用户希望让合作方看到的信息。</p>
<p><strong>如何使用</strong></p>
<ul>
<li>
...
<span class="line"><span style="color: #F8F8F2">     --header </span><span style="color: #E6DB74">&#39;Content-Type: application/json&#39;</span><span style="color: #F8F8F2"> \</span></span>
<span class="line"><span style="color: #F8F8F2">     --header </span><span style="color: #E6DB74">&#39;X-API-Key: test&#39;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看data-token信息" tabindex="-1"><a class="header-anchor" href="#查看data-token信息" aria-hidden="true">#</a> 查看Data Token信息</h3>
<p>选择对应的NFT合约，查看用户已经铸造的Data Token 列表。</p>
<p><strong>如何使用</strong></p>
<ul>
<li>
