<template><div><h1 id="联合模型训练" tabindex="-1"><a class="header-anchor" href="#联合模型训练" aria-hidden="true">#</a> 联合模型训练</h1>
<p><strong>主要功能</strong></p>
<p>在保证所有数据提供方不泄露各自敏感数据的前提下，完成联合模型训练。支持算法：逻辑回归、线性回归、DNN、XGBoost等。</p>
